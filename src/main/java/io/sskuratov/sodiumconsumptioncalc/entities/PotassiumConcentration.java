...
public class PotassiumConcentration implements Entity {
    ...
    public static final String CAPTION = "Концентрация калия в разовой порции мочи";
    private BigDecimal concentration;

    public static final BigDecimal MAX = new BigDecimal("100000.00");
    public static final BigDecimal MIN = BigDecimal.ZERO;

    public PotassiumConcentration(BigDecimal concentration) {
